...
class PlaneTest {
    ...
    void testGetNormal() {
        ...
        Plane pl = new Plane(new Point(0, 0, 1), new Point(1, 0, 0),
                new Point(0, 1, 0));
    ...
    void testFindIntersections() {
        ...
        r = new Ray(new Point(0, 0, -1), new Vector(0, 1, 1));
        p=new Point(0,1,0);
        result = pl.findIntersections(r);

        assertEquals(result.size(),1,
                "Ray intersects the plane - wrong number of intersections");
        assertEquals(result.get(0),p,"Ray intersects the plane - wrong Point of intersection");
        ...
        r = new Ray(new Point(2,1,0),new Vector(1,0,0));
        result=pl.findIntersections(r);
        ...
        assertEquals(result.get(0),p,"Ray starts before the plane " +
                "- wrong Point of intersection");
        ...
        r=new Ray(new Point(0,1,0),new Vector(0,-1,1));
        result=pl.findIntersections(r);
        assertNull(result, "Ray starts on the plane and not orthogonal nor parallel" +
                " - found and intersection");
        ...
        result=pl.findIntersections(r);
        assertNull(result, "Ray starts on the reference point of the plane" +
