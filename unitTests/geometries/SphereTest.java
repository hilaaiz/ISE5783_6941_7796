...
class SphereTest {
    ...
    void testFindIntersections() {
        ...
        assertNull(sp.findIntersections(new Ray(new Point(-6, 0, 0),
        ...
        result = sp.findIntersections(new Ray(new Point(0, 0, 0.5), new Vector(0,0,1)));
        ...
        assertNull(sp.findIntersections(new Ray(new Point(18, 0,0), new Vector(8, 2, 0) )),
        ...
        result = sp.findIntersections(new Ray(new Point(1, 0,1), new Vector(-1, 0,0)));
        assertEquals(result.size(), 1,"Ray starts at sphere and goes inside- wrong amount of points" );
        assertEquals(result.get(0), new Point(-5,0,1),
                "Ray starts at sphere and goes inside- wrong point");
        // TC12: Ray starts at sphere and goes outside (0 points)
        assertNull(sp.findIntersections(new Ray(new Point(5, 5,0), new Vector(0, 3,6))),
        ...
        p1 = new Point(-5, 0, 0);
        p2 = new Point(5, 0, 0);
        result = sp.findIntersections(new Ray(new Point(-7,0,0), new Vector(1,0,0)));
